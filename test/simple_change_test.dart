...
void main() => group('SimpleChange', () {
  group('.toJson()', () {
    test('should return a map with default values for a newly created instance', () {
      var map = const SimpleChange().toJson();
    ...
    test('should return a non-empty map for an initialized instance', () {
      var map = const SimpleChange(currentValue: 'bar', previousValue: 'baz').toJson();
      expect(map, hasLength(2));
  ...
  group('.toString()', () {
    var data = const SimpleChange(currentValue: 'bar', previousValue: 'baz').toString();
